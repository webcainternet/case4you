 ...
 <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
  ...
  <div class="cep">
  	<div class="campos-frete">
        ...
        <a class="text" href="#getCep">> Não sei meu CEP</a>
    </div>
  ...
  <div class="campos-total">
    ...
    <div class="total-total">
        ...
        <?php foreach($totals as $total) { ?>
            ...
            <?php } ?>
        <?php } ?>        
        <div class="text-obs">Ou em 6x de R$ <?php echo number_format(($real_valor / 6), 2, ",","."); ?>(Aplicar Cálculo Price)</div>
    </div>
  </div>
  	...
  	<div class="titu">2 - ENDEREÇO</div>
        <form action="" method="get" style="<?php if(empty($address["description"])) { ?>visibility:hidden<?php } ?>">
         ...
         <div class="novoEndereco hide">
            ...
            <span class="required">*</span> <label for="formEndDescription">Descrição:</label>
...
$('#button-payment-method').live('click', function() {
    ...
    var cep = $(".hd_cep").val();
    calcularFrete(cep, $(".tipo-entrega .radio:checked").val());
    setTimeout("finalizaPagamento()", 3000);
});
