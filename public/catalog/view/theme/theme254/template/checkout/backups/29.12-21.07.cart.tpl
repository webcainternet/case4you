 ...
 <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
  ...
  <div class="cep">
  	<div class="campos-frete">
        ...
        <a class="text" href="http://www.buscacep.correios.com.br/servicos/dnec/index.do" target="_blank">> Não sei meu CEP</a>
    </div>
...
$("#seta_cobranca").live("click", function() {
    getEnderecos(function (json) {
        ...
        $("#list_end_cobranca").slideToggle(500);
    });
});
...
$("#seta_entrega").live("click", function () {
    getEnderecos(function (json) {
        ...
        $("#list_end_entrega").slideToggle(300);
    });
});
...
function calcularFrete(cep, tipo, callback) {
    $.ajax({
            ...
            success: function(json) {
                ...
                valor_total = new String(valor_total);                
