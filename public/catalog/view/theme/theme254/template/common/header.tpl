...
<div id="header">
	...
	<div style="float: left;margin-top: 55px;margin-left: 0px;width: 220px;">
		...
		<div class="fontc4y1" style="color: #606060; float: left; width: 220px;text-align: center;margin-bottom: 10px;"><input type="text" value="" style="float: left;width: 155px;border-radius: 5px;
height: 25px;
margin-top: -10px;"><input type="image" src="/catalog/view/theme/theme254/image/button-search.png" style="width: 51px;
float: left;
margin-left: 5px;
border-radius: 5px;
margin-top: -10px;"></div>
