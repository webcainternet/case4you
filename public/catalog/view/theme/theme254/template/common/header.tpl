...
<div id="header">
	...
	<div style="float: left;margin-top: 78px;margin-left: 144px;width: 205px;">

		<div class="fontc4y1" style="color: #606060; font-size: 24px;float: left;width: 200px;">Quer novidades?</div>
		<div class="fontc4y2" style="color: #6aa11a; font-size: 24px;float: left;width: 80px;">Assine</div>
		<div class="fontc4y1" style="color: #606060; font-size: 24px;float: left;width: 200px;"> o Case4You!</div>
	</div>
