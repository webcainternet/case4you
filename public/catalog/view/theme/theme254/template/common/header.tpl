...
<div id="header">
	...
	<div style="float: left;margin-top: 78px;margin-left: 144px;"><img src="/image/data/indique2.png" style="width: 220px;" alt="Indique!"><a rel="shadowbox[Mixed]" href="http://case4you.com.br/case4you/0/">link temporario</a></div>
