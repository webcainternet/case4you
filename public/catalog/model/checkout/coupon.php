...
class ModelCheckoutCoupon extends Model {
	public function getCoupon($code) {
		...
		$coupon_query = $this->db->query("SELECT * FROM " . DB_PREFIX . "coupon WHERE code = '" . $this->db->escape(strtolower($code)) . "' AND ((date_start = '0000-00-00' OR date_start < NOW()) AND (date_end = '0000-00-00' OR date_end > NOW())) AND status = '1'");
		
		//echo "<pre>";
		//print_r($coupon_query);
		//die;
