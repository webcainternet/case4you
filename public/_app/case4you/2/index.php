...
<?php
    $ic = 0;
    $path    = '/var/www/case4you.com.br/public/app/case4you/uploads';
...
font-size: 14px;
">
			<img id="drag<?php echo $ic; ?>" src="http://case4you.com.br/app/case4you/1/uploads/<?php echo "$entry";?>" draggable="true"
...
<div style="display: block; float: left; width: 350px; border-left-style: solid; border-left-width: 1px; border-left-color: rgb(204, 204, 204); height: 540px; text-align: center; background-position: 15px 10px; background-repeat: no-repeat no-repeat;">
    	<div id="divmask" style="padding: 0px; height: <?php echo $mh; ?>px; width: 340px; margin-left: 10px; background-size: 340px; background-image: url(http://case4you.com.br/app/case4you/0/img/<?php echo $mimage; ?>); background-repeat: no-repeat no-repeat;">
...
<div id="divlixeira" ondrop="droplixeira(event)" ondragover="allowDrop(event)" style="float: right; margin-right: 10px; border: 0px; width: 55px; height: 55px; overflow: hidden;text-align: center;
        align: middle; background-image: url('http://case4you.com.br/image/data/Full_Trash.png'); background-size: 55px;"></div>
